...
class FieldServiceImplTest {
    ...
    fun `should get jira fields`() {
        ...
        val fields = fieldService.getFields()
        assertEquals("customfield_10026", fields[0].id)
        assertEquals("Story Points", fields[0].name)
        assertEquals("number", fields[0].schema["type"].toString())
    }
